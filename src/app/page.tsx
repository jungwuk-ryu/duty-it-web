...
import HomeExplore from "@/src/components/home/HomeExplore";
...
export const metadata: Metadata = {
  ...
  description: "간호사와 간호대학생을 위한 행사, 학술대회, 보수교육, 봉사와 채용 공고. 듀잇에서 관심 있는 기회를 찾고 북마크로 모아보세요.",
  openGraph: {
    title: "간호의 내일을, 발견하는 곳 | 듀잇",
    description: "배우고 경험하고 나아가는 당신을 위해. 간호 행사부터 채용까지, 듀잇에서 만나보세요.",
  ...
  twitter: {
    ...
    title: "간호의 내일을, 발견하는 곳 | 듀잇",
    description: "간호 행사부터 채용까지, 듀잇에서 만나보세요.",

            ...
            <article className="overflow-hidden rounded-2xl border border-border/80 bg-background shadow-[0_16px_40px_rgba(15,23,42,0.08),0_2px_8px_rgba(15,23,42,0.04)]">
                <header className="border-b border-border/60 px-5 py-6 md:px-8 md:py-8">
                    ...
                    <div className="mt-6 flex flex-wrap gap-2">
                        ...
                        <Link href="/jobs" className={buttonVariants({ variant: "outline", className: "h-10 border-input text-foreground" })}>다른 공고 보기</Link>
                    </div>
                </header>
                ...
                <div className="flex flex-col gap-8 px-5 py-6 md:px-8 md:py-8">
                    ...
                    <section className="border-t border-border/60 pt-7" aria-labelledby="application-info">
                        <h2 id="application-info" className="text-lg font-bold text-foreground">지원 정보</h2>
                    ...
                    {(job.fourIns || job.retirepay || job.etcWelfare) && (
                        <section className="border-t border-border/60 pt-7" aria-labelledby="benefits">
                            <h2 id="benefits" className="text-lg font-bold text-foreground">복리후생</h2>
                            <dl className="mt-4 grid grid-cols-1 gap-x-8 gap-y-5 sm:grid-cols-2">
                    ...
                    <section className="border-t border-border/60 pt-7" aria-label="채용 정보 출처">
                        <Image

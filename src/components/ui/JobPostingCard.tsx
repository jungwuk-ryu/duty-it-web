...
export default function JobPostingCard({ job }: Props) {
    ...
    return (
        <article className="group h-full overflow-hidden rounded-2xl border border-border/80 bg-background shadow-[0_12px_32px_rgba(15,23,42,0.06),0_2px_6px_rgba(15,23,42,0.03)] transition duration-200 hover:-translate-y-0.5 hover:border-brand/30 hover:shadow-[0_18px_40px_rgba(15,23,42,0.10),0_4px_10px_rgba(198,60,51,0.06)]">

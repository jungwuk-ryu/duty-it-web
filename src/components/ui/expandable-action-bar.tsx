...
import { useDismiss } from "@/src/components/ui/expandable-action-bar-utils/use-dismiss";
import { useHoverGesture } from "@/src/components/ui/expandable-action-bar-utils/use-hover-gesture";
import { useTapGesture } from "@/src/components/ui/expandable-action-bar-utils/use-tap-gesture";
      ...
      >
        <motion.div
          ...
          className={cn(
            ...
            "scrollbar-hide relative inline-flex max-w-full items-center overflow-x-auto overflow-y-hidden rounded-full border border-border bg-background/95 shadow-lg backdrop-blur-xl",
            SIZE_CLASS[size],
            classNames?.track,
          )}
          transition={ITEM_TRANSITION}

...
export default function AccountMenu({ onNavigate, className }: { onNavigate?: () => void; className?: string }) {
    ...
    return <div className="relative">
        <DropdownMenu>
            <DropdownMenuTrigger asChild><Button variant="ghost" className={cn("gap-2", className)} disabled={pending} aria-label="내 계정 메뉴">
